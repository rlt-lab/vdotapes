...
class VideoGridVirtualizer {
    ...
    setContainer(container) {
        ...
        console.log('Virtualizer container set, scroll container:', this.scrollContainer === window ? 'window' : this.scrollContainer.tagName);
        this.updateLayout();
    }
    ...
    calculateVisibleRange() {
        const scrollTop = this.scrollContainer === window ? 
            window.pageYOffset : this.scrollContainer.scrollTop;
        const containerHeight = this.scrollContainer === window ? 
            window.innerHeight : this.scrollContainer.clientHeight;
        ...
        const gridHTML = `
            ...
            <div class="video-grid virtual-grid" style="--grid-cols: ${this.itemsPerRow};">
                ${visibleVideos.map((video, index) => 
                    this.createVideoItemHTML(video, this.startIndex + index)
                ).join('')}
            </div>
