...
![VDOTapes Screenshot](app/assets/icon.png)
...
**macOS:**
- Download `VDOTapes-1.0.0-arm64.dmg`
- Drag to Applications folder
- Launch from Applications or Spotlight

**Windows:**
- Download `VDOTapes 1.0.0.exe` (portable)
- Run directly - no installation required
- Or use `VDOTapes Setup 1.0.0.exe` for traditional install

### First Launch
1. **Open VDOTapes** from your Applications/Start Menu
